    ...
    stages {
        stage('checkout') {
            steps {
                ...
                sh 'git clone https://github.com/Gowda1993/weather-update.git'
            }
        }
        ...
        stage('deploy') {
            steps {
                ...
                sh "scp /home/slave1/workspace/weather-update_Develop/target/weather-forecast-app-1.0-SNAPSHOT.jar root@172.31.22.10:/opt/apache-tomcat-9.0.85/webapps/"
            }
        }
